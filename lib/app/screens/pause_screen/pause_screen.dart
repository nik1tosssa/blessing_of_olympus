...
class PauseScreen extends StatefulWidget {
  ...
  @override
  State<PauseScreen> createState() => _PauseScreenState(); // Соответствие имени
}
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: CustomButton(
                  ...
                  onPressed: () {
                    // --- ИЗМЕНЕНИЕ ЗДЕСЬ ---
                    // Возвращаемся на предыдущий экран (GameScreen)
              ...
              // SizedBox(height: 30,), // Этот SizedBox здесь не влияет на позиционирование кнопок в Stack
              Padding(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text( // Оставляем ваш вариант без Expanded для сохранения верстки
            text,
...
//
//   @override
//   State<PauseScreen> createState() => _SettingsScreenState();
// }
//
// class _SettingsScreenState extends State<PauseScreen> {
//   bool _soundEnabled = true;
//   bool _musicEnabled = true;
//   bool _vibrationEnabled = true;
//
